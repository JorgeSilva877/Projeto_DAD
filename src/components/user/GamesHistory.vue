...
<template>
    <div class="p-6">
      ...
      <div class="overflow-auto">
        <table v-if="storeGame.getPersonalGames.length > 0" class="w-full bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <tbody class="text-center">
            <tr v-for="game in storeGame.getPersonalGames" class="border-b hover:bg-yellow-100 transition">
              ...
              <td class="py-3 px-4 text-center">
                <button
                  class="bg-yellow-400 text-yellow-800 p-2 rounded-full hover:bg-yellow-500 transition"
